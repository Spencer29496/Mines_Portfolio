      ...
      <section className="py-20 relative">
        ...
        <div className="container mx-auto px-4 flex flex-col items-center text-center relative z-10">
          ...
          <p className="text-xl md:text-2xl max-w-2xl mb-8">
            Computer Science Student & <span className="text-accent-primary">Cosmic</span> Developer
          </p>
          <a
            href="#projects"
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-4 backdrop-blur-sm bg-background/20 p-6 rounded-lg border border-accent-primary/20">
              <p className="text-lg">
                ...
                software development, machine learning, and exploring the digital universe.
              </p>
              <p className="text-lg">
              ...
              <p className="text-lg">
                ...
                to create innovative solutions that reach for the stars.
              </p>
            </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-md mx-auto backdrop-blur-sm bg-background/20 p-8 rounded-lg border border-accent-primary/20 hover:border-accent-primary/30 transition-all duration-300">
            <p className="text-center mb-6">
              Ready to start a cosmic collaboration? Send me a message and let's explore the possibilities together.
            </p>
            ...
            <div className="flex justify-center gap-6 mt-8">
              <a href="https://github.com/" target="_blank" rel="noopener noreferrer" className="text-accent-primary hover:text-accent-secondary transition-colors">
              ...
              <a href="https://twitter.com/" target="_blank" rel="noopener noreferrer" className="text-accent-primary hover:text-accent-secondary transition-colors">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <footer className="py-6 border-t border-accent-primary/20 relative">
        ...
        <div className="container mx-auto px-4 relative">
          <p className="text-center text-sm text-accent-primary/70">
            © {new Date().getFullYear()} Spencer Mines. All rights reserved. <span className="text-foreground/50">Exploring the digital cosmos</span>
          </p>
        </div>
      </footer>
    </div>
